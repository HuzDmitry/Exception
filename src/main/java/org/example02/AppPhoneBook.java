 ...
 * параметры. Если форматы данных не совпадают, нужно бросить исключение,
 ...
 *
 * Критерии оценивания:
 * Слушатель напишите приложение, которое будет запрашивать у пользователя следующие данные в
...
public class AppPhoneBook {
    public static void main(String[] args) {
        ...
        if(!builder.createUser()){
            System.out.println("попробуйте еще раз");
        }else {
            reader.saveUser(builder.getDataUser());
            System.out.println(Arrays.toString(builder.getDataUser()));
        }
